 ...
 */
class GetSharingPreferencesUseCase
    @Inject
    constructor(
        private val repository: SettingsRepository,
    ) {
 ...
 */
class SetEnableSemanticSearchUseCase
    @Inject
    constructor(
        private val repository: SettingsRepository,
    ) {
 ...
 */
class SetSaveSearchHistoryUseCase
    @Inject
    constructor(
        private val repository: SettingsRepository,
    ) {
 ...
 */
class SetHoldToShareDelayUseCase
    @Inject
    constructor(
        private val repository: SettingsRepository,
    ) {
 ...
 */
class SetDefaultQualityUseCase
    @Inject
    constructor(
        private val repository: SettingsRepository,
    ) {
 ...
 */
class SetDefaultMaxDimensionUseCase
    @Inject
    constructor(
        private val repository: SettingsRepository,
    ) {
