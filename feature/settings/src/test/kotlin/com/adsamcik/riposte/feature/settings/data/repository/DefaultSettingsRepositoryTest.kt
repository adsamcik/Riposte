...
class DefaultSettingsRepositoryTest {
    ...
    @Test
    fun `appPreferences emits values from datastore`() =
        runTest {
    ...
    @Test
    fun `sharingPreferences emits values from datastore`() =
        runTest {
    ...
    @Test
    fun `setDarkMode delegates to datastore`() =
        runTest {
    ...
    @Test
    fun `setDynamicColors updates app preferences with new value`() =
        runTest {
    ...
    @Test
    fun `setEnableSemanticSearch updates app preferences with new value`() =
        runTest {
            val prefsSlot = slot<AppPreferences>()
            coEvery { preferencesDataStore.updateAppPreferences(capture(prefsSlot)) } returns Unit
    ...
    @Test
    fun `setSaveSearchHistory updates app preferences with new value`() =
        runTest {
            val prefsSlot = slot<AppPreferences>()
            coEvery { preferencesDataStore.updateAppPreferences(capture(prefsSlot)) } returns Unit
    ...
    @Test
    fun `setHoldToShareDelay updates app preferences with new value`() =
        runTest {
            val prefsSlot = slot<AppPreferences>()
            coEvery { preferencesDataStore.updateAppPreferences(capture(prefsSlot)) } returns Unit
    ...
    @Test
    fun `setDefaultFormat updates sharing preferences with new value`() =
        runTest {
    ...
    @Test
    fun `setDefaultQuality updates sharing preferences with new value`() =
        runTest {
            val prefsSlot = slot<SharingPreferences>()
            coEvery { preferencesDataStore.updateSharingPreferences(capture(prefsSlot)) } returns Unit
    ...
    @Test
    fun `setDefaultMaxDimension updates both maxWidth and maxHeight`() =
        runTest {
            val prefsSlot = slot<SharingPreferences>()
            coEvery { preferencesDataStore.updateSharingPreferences(capture(prefsSlot)) } returns Unit
    ...
    @Test
    fun `exportPreferences returns valid JSON`() =
        runTest {
    ...
    @Test
    fun `importPreferences with valid JSON succeeds`() =
        runTest {
            val prefsSlot = slot<SharingPreferences>()
    ...
    @Test
    fun `importPreferences with invalid JSON returns failure`() =
        runTest {
    ...
    @Test
    fun `importPreferences preserves existing values for missing fields`() =
        runTest {
            val prefsSlot = slot<SharingPreferences>()
            coEvery { preferencesDataStore.updateSharingPreferences(capture(prefsSlot)) } returns Unit
