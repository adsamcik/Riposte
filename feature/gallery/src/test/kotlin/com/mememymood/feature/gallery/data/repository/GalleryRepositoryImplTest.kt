...
class GalleryRepositoryImplTest {
    ...
    @Test
    fun `getMemes returns flow of memes from dao`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getMemes returns empty list when dao returns empty`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getMemes maps entity to domain correctly`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getFavorites returns only favorite memes`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getFavorites returns empty list when no favorites`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getMemeById returns meme when found`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getMemeById returns null when not found`() = runTest(testDispatcher) {
    ...
    @Test
    fun `observeMeme emits meme updates`() = runTest(testDispatcher) {
        val entity = testMemeEntities[0]
    ...
    @Test
    fun `observeMeme emits null when meme not found`() = runTest(testDispatcher) {
    ...
    @Test
    fun `updateMeme returns success when update succeeds`() = runTest(testDispatcher) {
        coEvery { memeDao.updateMeme(any()) } just Runs

        val result = repository.updateMeme(
            com.mememymood.core.model.Meme(
                id = 1,
    ...
    @Test
    fun `updateMeme returns failure when exception thrown`() = runTest(testDispatcher) {
    ...
    @Test
    fun `updateMemeWithEmojis updates meme and emoji tags`() = runTest(testDispatcher) {
        val emojiTags = listOf(
        ...
        val result = repository.updateMemeWithEmojis(
            com.mememymood.core.model.Meme(
                id = 1,
                filePath = "/storage/memes/meme1.jpg",
                fileName = "meme1.jpg",
    ...
    @Test
    fun `updateMemeWithEmojis clears emoji tags when empty`() = runTest(testDispatcher) {
        coEvery { memeDao.updateMeme(any()) } just Runs
        coEvery { emojiTagDao.deleteEmojiTagsForMeme(1) } just Runs
    ...
    @Test
    fun `updateMemeWithEmojis returns failure on error`() = runTest(testDispatcher) {
    ...
    @Test
    fun `deleteMeme deletes meme from database successfully`() = runTest(testDispatcher) {
        val entity = testMemeEntities[0]
        coEvery { memeDao.getMemeById(1) } returns entity
    ...
    @Test
    fun `deleteMeme succeeds when meme not found`() = runTest(testDispatcher) {
        coEvery { memeDao.getMemeById(999) } returns null
    ...
    @Test
    fun `deleteMeme returns failure when exception thrown`() = runTest(testDispatcher) {
    ...
    @Test
    fun `deleteMemes deletes multiple memes successfully`() = runTest(testDispatcher) {
    ...
    @Test
    fun `deleteMemes handles empty set`() = runTest(testDispatcher) {
    ...
    @Test
    fun `deleteMemes returns failure when exception thrown`() = runTest(testDispatcher) {
    ...
    @Test
    fun `toggleFavorite succeeds`() = runTest(testDispatcher) {
    ...
    @Test
    fun `toggleFavorite returns failure when exception thrown`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getMemesByEmoji returns memes matching emoji`() = runTest(testDispatcher) {
    ...
    @Test
    fun `getMemesByEmoji returns empty list for unknown emoji`() = runTest(testDispatcher) {
