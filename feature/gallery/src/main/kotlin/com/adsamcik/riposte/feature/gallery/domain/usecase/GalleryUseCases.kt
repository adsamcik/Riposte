...
class GetPagedMemesUseCase
    ...
    constructor(
        ...
        ): Flow<PagingData<Meme>> = repository.getPagedMemes(sortBy).cachedIn(scope)
    }
 ...
 */
class GetRecentlyViewedMemesUseCase
    @Inject
    constructor(
        private val repository: GalleryRepository,
    ) {
