 ...
 */
class ImportNotificationManager @Inject constructor(
    ...
    fun buildCompleteNotification(successCount: Int, failedCount: Int): Notification {
        val text = when {
    ...
    fun showCompleteNotification(successCount: Int, failedCount: Int) {
