...
class ImportWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        // Final status
        val finalStatus = if (failed == request.imageCount) {
    ...
    private suspend fun maybePromoteToForeground(current: Int, total: Int) {
        if (appLifecycleTracker.isInBackground.value) {
    ...
    companion object {
         ...
         */
        fun enqueue(context: Context, requestId: String): Data {
