...
class ImportRepositoryImplEdgeCasesTest {
    ...
    @Test
    fun `importImage returns failure when SecurityException thrown on URI access`() = runTest {
    ...
    @Test
    fun `importImage returns failure when stream throws SecurityException`() = runTest {
        val mockContext = mockk<Context>(relaxed = true)
        val mockContentResolver = mockk<ContentResolver>()
    ...
    @Test
    fun `importImage returns failure when IOException thrown on stream open`() = runTest {
        val mockContext = mockk<Context>(relaxed = true)
        val mockContentResolver = mockk<ContentResolver>()
    ...
    @Test
    fun `importImage returns failure for null bitmap`() = runTest {
        val mockContext = mockk<Context>(relaxed = true)
        val mockContentResolver = mockk<ContentResolver>()
    ...
    @Test
    fun `importImage returns failure for corrupted image data`() = runTest {
        val mockContext = mockk<Context>(relaxed = true)
        val mockContentResolver = mockk<ContentResolver>()
        ...
        every { mockContentResolver.openInputStream(any()) } returns ByteArrayInputStream("not an image".toByteArray())
    ...
    @Test
    fun `importImage cleans up files when database insert fails`() = runTest {
    ...
    @Test
    fun `importImage handles null metadata`() = runTest {
        val uri = createTestImageUri()
    ...
    @Test
    fun `importImage handles very long title in metadata`() = runTest {
        val uri = createTestImageUri()
    ...
    @Test
    fun `importImage handles unicode in metadata`() = runTest {
        val uri = createTestImageUri()
        val metadata = MemeMetadata(
            emojis = listOf("😀", "🔥", "👾"),
            title = "日本語タイトル",
    ...
    @Test
    fun `importImages handles empty list`() = runTest {
    ...
    @Test
    fun `importImages returns results for all URIs even with failures`() = runTest {
    ...
    @Test
    fun `extractText returns null for unreadable URI`() = runTest {
        val mockContext = mockk<Context>(relaxed = true)
        val mockContentResolver = mockk<ContentResolver>()
    ...
    @Test
    fun `extractText returns null when OCR fails`() = runTest {
        val uri = createTestImageUri()
    ...
    @Test
    fun `suggestEmojis returns empty list for unreadable image`() = runTest {
        val mockContext = mockk<Context>(relaxed = true)
        val mockContentResolver = mockk<ContentResolver>()
