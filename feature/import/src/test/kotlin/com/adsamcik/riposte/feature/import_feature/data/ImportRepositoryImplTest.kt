...
class ImportRepositoryImplTest {
    ...
    @Test
    fun `importImage returns success when import succeeds`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `importImage uses metadata when provided`() =
        runTest {
            // Arrange
            val uri = createTestImageUri()
            val metadata =
    ...
    @Test
    fun `importImage schedules background embedding generation`() =
        runTest {
            // Arrange
            val uri = createTestImageUri()
            val memeId = 3L
    ...
    @Test
    fun `importImage returns failure when database insert fails`() =
        runTest {
            // Arrange
            val uri = createTestImageUri()
    ...
    @Test
    fun `importImages returns results for all uris`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `extractMetadata delegates to xmpMetadataHandler`() =
        runTest {
            // Arrange
            val uri = mockk<Uri>()
    ...
    @Test
    fun `extractMetadata returns null when no metadata exists`() =
        runTest {
            // Arrange
            val uri = mockk<Uri>()
    ...
    @Test
    fun `extractText uses textRecognizer`() =
        runTest {
            // Arrange
            val uri = createTestImageUri()
    ...
    @Test
    fun `extractText returns null on error`() =
        runTest {
            // Arrange
            val uri = mockk<Uri>()
