...
class ImportUseCasesTest {
    ...
    @Test
    fun `ImportImageUseCase calls repository with uri and null metadata`() = runTest {
        val uri = mockk<Uri>()
        val meme = mockk<Meme>()
    ...
    @Test
    fun `ImportImageUseCase calls repository with uri and metadata`() = runTest {
        val uri = mockk<Uri>()
    ...
    @Test
    fun `ImportImageUseCase returns failure when repository fails`() = runTest {
        val uri = mockk<Uri>()
    ...
    @Test
    fun `ImportImagesUseCase calls repository with list of uris`() = runTest {
        val uri1 = mockk<Uri>()
        val uri2 = mockk<Uri>()
        val meme1 = mockk<Meme>()
        val meme2 = mockk<Meme>()
        coEvery { repository.importImages(listOf(uri1, uri2)) } returns listOf(
    ...
    @Test
    fun `ImportImagesUseCase handles partial failures`() = runTest {
        val uri1 = mockk<Uri>()
        val uri2 = mockk<Uri>()
        val meme1 = mockk<Meme>()
        val error = RuntimeException("Import failed")
    ...
    @Test
    fun `ImportImagesUseCase handles empty list`() = runTest {
    ...
    @Test
    fun `ExtractMetadataUseCase returns metadata from repository`() = runTest {
        val uri = mockk<Uri>()
    ...
    @Test
    fun `ExtractMetadataUseCase returns null when no metadata`() = runTest {
        val uri = mockk<Uri>()
    ...
    @Test
    fun `SuggestEmojisUseCase returns suggested emojis`() = runTest {
        val uri = mockk<Uri>()
        val emojis = listOf(
            EmojiTag("😀", "happy"),
            EmojiTag("😂", "laughing")
    ...
    @Test
    fun `SuggestEmojisUseCase returns empty list when no suggestions`() = runTest {
        val uri = mockk<Uri>()
    ...
    @Test
    fun `ExtractTextUseCase returns extracted text`() = runTest {
        val uri = mockk<Uri>()
    ...
    @Test
    fun `ExtractTextUseCase returns null when no text found`() = runTest {
        val uri = mockk<Uri>()
    ...
    @Test
    fun `ExtractTextUseCase returns empty string for blank text`() = runTest {
        val uri = mockk<Uri>()
