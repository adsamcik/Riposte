...
class ShareUseCasesTest {
    ...
    @Test
    fun `getMeme returns meme from repository`() =
        runTest {
    ...
    @Test
    fun `getMeme returns null when meme not found`() =
        runTest {
    ...
    @Test
    fun `getMeme with different IDs calls repository with correct ID`() =
        runTest {
    ...
    @Test
    fun `getDefaultConfig returns config from repository`() =
        runTest {
    ...
    @Test
    fun `getDefaultConfig returns custom config from repository`() =
        runTest {
            val customConfig =
                ShareConfig(
    ...
    @Test
    fun `prepareForSharing returns success result from repository`() =
        runTest {
    ...
    @Test
    fun `prepareForSharing returns failure result from repository`() =
        runTest {
    ...
    @Test
    fun `prepareForSharing passes correct config to repository`() =
        runTest {
            val customConfig =
                ShareConfig(
    ...
    @Test
    fun `saveToGallery returns success result from repository`() =
        runTest {
    ...
    @Test
    fun `saveToGallery returns failure result from repository`() =
        runTest {
    ...
    @Test
    fun `saveToGallery passes correct config to repository`() =
        runTest {
            val highQualityConfig =
                ShareConfig(
                    format = ImageFormat.PNG,
                    quality = 100,
                    maxWidth = null,
    ...
    @Test
    fun `estimateFileSize returns size from repository`() =
        runTest {
    ...
    @Test
    fun `estimateFileSize returns different sizes for different configs`() =
        runTest {
    ...
    @Test
    fun `estimateFileSize returns small size for low quality JPEG`() =
        runTest {
