...
class FlowUtilsTest {
    ...
    @Test
    fun `asResource emits Loading first then Success`() =
        runTest {
    ...
    @Test
    fun `asResource emits multiple Success items after Loading`() =
        runTest {
    ...
    @Test
    fun `asResource emits Error when flow throws exception`() =
        runTest {
    ...
    @Test
    fun `asResource handles null exception message`() =
        runTest {
            val exception =
                object : Exception() {
    ...
    @Test
    fun `asResource emits some items before error`() =
        runTest {
    ...
    @Test
    fun `asResource handles empty flow`() =
        runTest {
    ...
    @Test
    fun `asResource with complex object type`() =
        runTest {
    ...
    @Test
    fun `asResource with nullable values`() =
        runTest {
    ...
    @Test
    fun `safeCall returns Success when block succeeds`() =
        runTest {
    ...
    @Test
    fun `safeCall returns Success with computed value`() =
        runTest {
            val result =
                safeCall {
                    val a = 5
    ...
    @Test
    fun `safeCall returns Error when block throws exception`() =
        runTest {
    ...
    @Test
    fun `safeCall handles exception with null message`() =
        runTest {
            val exception =
                object : Exception() {
                    override val message: String? = null
    ...
    @Test
    fun `safeCall handles different exception types`() =
        runTest {
    ...
    @Test
    fun `safeCall with suspend operation`() =
        runTest {
            val result =
                safeCall {
    ...
    @Test
    fun `safeCall with nullable return type`() =
        runTest {
    ...
    @Test
    fun `safeCall with complex object`() =
        runTest {
    ...
    @Test
    fun `safeCall preserves exception type in Error`() =
        runTest {
    ...
    @Test
    fun `safeCall with nested suspend calls`() =
        runTest {
    ...
    @Test
    fun `asResource and safeCall work together in typical use case`() =
        runTest {
    ...
    @Test
    fun `asResource handles flow that delays emissions`() =
        runTest {
            val flow =
                flow {
                    kotlinx.coroutines.delay(10)
