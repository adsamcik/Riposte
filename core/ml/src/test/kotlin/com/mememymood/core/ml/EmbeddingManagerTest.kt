...
class EmbeddingManagerTest {
    ...
    @Test
    fun `generateAndStoreEmbedding creates embedding and stores it`() = runTest {
        // Given
        val memeId = 1L
    ...
    @Test
    fun `generateAndStoreEmbedding returns false on failure`() = runTest {
        // Given
        val memeId = 1L
        val searchText = "funny cat meme"
    ...
    @Test
    fun `getEmbedding returns decoded embedding`() = runTest {
        // Given
        val memeId = 1L
    ...
    @Test
    fun `getEmbedding returns null when not found`() = runTest {
        // Given
    ...
    @Test
    fun `hasValidEmbedding delegates to DAO`() = runTest {
        // Given
    ...
    @Test
    fun `checkAndHandleModelUpgrade marks old embeddings for regeneration`() = runTest {
        // Given
    ...
    @Test
    fun `checkAndHandleModelUpgrade does nothing when no upgrade`() = runTest {
        // Given
