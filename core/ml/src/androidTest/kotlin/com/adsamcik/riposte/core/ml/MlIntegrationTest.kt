...
class MlIntegrationTest {
    ...
    @Test
    fun textRecognizer_extractsTextFromBitmap() =
        runTest {
    ...
    @Test
    fun textRecognizer_handlesLargeBitmap() =
        runTest {
    ...
    @Test
    fun textRecognizer_handlesSmallBitmap() =
        runTest {
    ...
    @Test
    fun embeddingGenerator_generatesEmbeddingForText() =
        runTest {
    ...
    @Test
    fun embeddingGenerator_generatesConsistentEmbeddings() =
        runTest {
    ...
    @Test
    fun embeddingGenerator_differentTextsDifferentEmbeddings() =
        runTest {
    ...
    @Test
    fun embeddingGenerator_handlesEmptyText() =
        runTest {
    ...
    @Test
    fun embeddingGenerator_handlesLongText() =
        runTest {
    ...
    @Test
    fun semanticSearch_findsSimilarContent() =
        runTest {
    ...
    @Test
    fun semanticSearch_returnsRelevanceScores() =
        runTest {
            val testContent =
                mapOf(
    ...
    @Test
    fun semanticSearch_respectsLimit() =
        runTest {
            // Add many items
            (1L..20L).forEach { id ->
    ...
    @Test
    fun semanticSearch_emptyQueryReturnsEmpty() =
        runTest {
    ...
    @Test
    fun semanticSearch_removesFromIndex() =
        runTest {
    ...
    @Test
    fun fullPipeline_extractsAndIndexesContent() =
        runTest {
            // Create bitmap
            val bitmap = Bitmap.createBitmap(100, 100, Bitmap.Config.ARGB_8888)
    ...
    @Test
    fun fullPipeline_handlesMultipleMemes() =
        runTest {
            val memeTexts =
                listOf(
                    1L to "Laughing cat",
    ...
    @Test
    fun performance_indexingManyMemes() =
        runTest {
    ...
    @Test
    fun performance_searchWithManyIndexedItems() =
        runTest {
