...
class PreferencesDataStoreTest {
    ...
    @Test
    fun `appPreferences returns defaults when no preferences set`() =
        runTest {
    ...
    @Test
    fun `updateAppPreferences stores preferences correctly`() =
        runTest {
            val customPrefs =
                AppPreferences(
    ...
    @Test
    fun `setDarkMode updates dark mode preference`() =
        runTest {
    ...
    @Test
    fun `setGridColumns clamps value between 2 and 4`() =
        runTest {
            // Test lower bound
    ...
    @Test
    fun `sharingPreferences returns defaults when no preferences set`() =
        runTest {
    ...
    @Test
    fun `updateSharingPreferences stores preferences correctly`() =
        runTest {
            val customPrefs =
                SharingPreferences(
    ...
    @Test
    fun `recentSearches returns empty list initially`() =
        runTest {
    ...
    @Test
    fun `addRecentSearch adds query to front of list`() =
        runTest {
    ...
    @Test
    fun `addRecentSearch moves existing query to front`() =
        runTest {
            preferencesDataStore.addRecentSearch("query1")
            preferencesDataStore.addRecentSearch("query2")
    ...
    @Test
    fun `deleteRecentSearch removes specific query`() =
        runTest {
            preferencesDataStore.addRecentSearch("query1")
            preferencesDataStore.addRecentSearch("query2")
    ...
    @Test
    fun `clearRecentSearches removes all searches`() =
        runTest {
            preferencesDataStore.addRecentSearch("query1")
            preferencesDataStore.addRecentSearch("query2")
    ...
    @Test
    fun `addRecentSearch keeps maximum of 20 searches`() =
        runTest {
            // Add 25 searches
            repeat(25) { i ->
    ...
    @Test
    fun `hasShownEmojiTip returns false by default`() =
        runTest {
    ...
    @Test
    fun `setEmojiTipShown marks emoji tip as shown`() =
        runTest {
    ...
    @Test
    fun `hasShownSearchTip returns false by default`() =
        runTest {
    ...
    @Test
    fun `setSearchTipShown marks search tip as shown`() =
        runTest {
    ...
    @Test
    fun `hasShownShareTip returns false by default`() =
        runTest {
    ...
    @Test
    fun `setShareTipShown marks share tip as shown`() =
        runTest {
    ...
    @Test
    fun `tip shown state persists and is not repeated`() =
        runTest {
            // Initially not shown
            preferencesDataStore.hasShownEmojiTip.test {
                assertThat(awaitItem()).isFalse()
    ...
    @Test
    fun `each tip tracks independently`() =
        runTest {
            preferencesDataStore.setEmojiTipShown()
    ...
    @Test
    fun `clearAll resets tip shown state`() =
        runTest {
            preferencesDataStore.setEmojiTipShown()
            preferencesDataStore.setSearchTipShown()
            preferencesDataStore.setShareTipShown()
