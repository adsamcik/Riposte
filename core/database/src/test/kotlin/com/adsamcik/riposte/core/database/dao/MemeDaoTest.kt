...
class MemeDaoTest {
    ...
    @Test
    fun `insertMeme returns generated id`() = runTest {
    ...
    @Test
    fun `insertMeme with replace strategy updates existing meme`() = runTest {
    ...
    @Test
    fun `insertMemes inserts multiple memes and returns ids`() = runTest {
        val memes = listOf(
    ...
    @Test
    fun `getMemeById returns correct meme`() = runTest {
        val meme = createMeme(
    ...
    @Test
    fun `getMemeById returns null for non-existent id`() = runTest {
    ...
    @Test
    fun `getAllMemes returns memes ordered by importedAt descending`() = runTest {
    ...
    @Test
    fun `getAllMemes emits empty list when database is empty`() = runTest {
        memeDao.getAllMemes().test {
            val result = awaitItem()
    ...
    @Test
    fun `getFavoriteMemes returns only favorites ordered by importedAt`() = runTest {
        val now = System.currentTimeMillis()
        memeDao.insertMemes(
            listOf(
                createMeme(
    ...
    @Test
    fun `observeMemeById emits updates when meme changes`() = runTest {
    ...
    @Test
    fun `observeMemeById emits null for non-existent meme`() = runTest {
    ...
    @Test
    fun `getMemeCount returns correct count`() = runTest {
    ...
    @Test
    fun `memeExistsByPath returns true for existing path`() = runTest {
    ...
    @Test
    fun `memeExistsByPath returns false for non-existent path`() = runTest {
    ...
    @Test
    fun `updateMeme updates all fields`() = runTest {
        val original = createMeme(
    ...
    @Test
    fun `toggleFavorite toggles favorite status from false to true`() = runTest {
    ...
    @Test
    fun `toggleFavorite toggles favorite status from true to false`() = runTest {
    ...
    @Test
    fun `setFavorite sets favorite to true`() = runTest {
    ...
    @Test
    fun `setFavorite sets favorite to false`() = runTest {
    ...
    @Test
    fun `updateEmbedding updates embedding for meme`() = runTest {
    ...
    @Test
    fun `getMemesWithoutEmbeddings returns memes with null embeddings`() = runTest {
        memeDao.insertMemes(
            listOf(
    ...
    @Test
    fun `getMemesWithoutEmbeddings respects limit`() = runTest {
        memeDao.insertMemes(
            (1..10).map { i ->
    ...
    @Test
    fun `deleteMeme removes meme from database`() = runTest {
    ...
    @Test
    fun `deleteMemeById removes meme by id`() = runTest {
    ...
    @Test
    fun `deleteMemesByIds removes multiple memes`() = runTest {
        val ids = memeDao.insertMemes(
            listOf(
    ...
    @Test
    fun `deleteMemesByIds with empty list does nothing`() = runTest {
    ...
    @Test
    fun `getAllMemes emits new value when meme is inserted`() = runTest {
        memeDao.getAllMemes().test {
    ...
    @Test
    fun `getAllMemes emits new value when meme is deleted`() = runTest {
    ...
    @Test
    fun `getFavoriteMemes emits when favorite status changes`() = runTest {
