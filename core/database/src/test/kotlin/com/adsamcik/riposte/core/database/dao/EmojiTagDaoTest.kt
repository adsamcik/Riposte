...
class EmojiTagDaoTest {
    ...
    @Test
    fun `insertEmojiTags inserts tags for a meme`() = runTest {
    ...
    @Test
    fun `insertEmojiTags with replace strategy updates existing tags`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
    ...
    @Test
    fun `insertEmojiTags with empty list does nothing`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
    ...
    @Test
    fun `getEmojiTagsForMeme returns all tags for a meme`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        val tags = listOf(
            createEmojiTag(memeId, "😂", "face_with_tears_of_joy"),
            createEmojiTag(memeId, "🔥", "fire")
    ...
    @Test
    fun `getEmojiTagsForMeme returns empty list for meme without tags`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
    ...
    @Test
    fun `getEmojiTagsForMeme returns empty list for non-existent meme`() = runTest {
    ...
    @Test
    fun `observeEmojiTagsForMeme emits updates when tags change`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
    ...
    @Test
    fun `getMemeIdsWithEmoji returns meme ids with specific emoji`() = runTest {
    ...
    @Test
    fun `getMemeIdsWithEmoji returns empty list when no memes have emoji`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        emojiTagDao.insertEmojiTags(
            listOf(createEmojiTag(memeId, "😂", "face_with_tears_of_joy"))
        )
    ...
    @Test
    fun `getMemeIdsWithAnyEmoji returns meme ids with any of the emojis`() = runTest {
        val meme1Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        val meme2Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme2.png"))
        val meme3Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme3.png"))
    ...
    @Test
    fun `getMemeIdsWithAnyEmoji returns distinct meme ids`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        emojiTagDao.insertEmojiTags(
            listOf(
                createEmojiTag(memeId, "😂", "face_with_tears_of_joy"),
    ...
    @Test
    fun `getMemeIdsWithAllEmojis returns meme ids with all emojis`() = runTest {
        val meme1Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        val meme2Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme2.png"))
        val meme3Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme3.png"))
    ...
    @Test
    fun `getMemeIdsWithAllEmojis returns empty when no memes have all emojis`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        emojiTagDao.insertEmojiTags(
            listOf(createEmojiTag(memeId, "😂", "face_with_tears_of_joy"))
        )
    ...
    @Test
    fun `getAllEmojisWithCounts returns emoji usage statistics`() = runTest {
        val meme1Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        val meme2Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme2.png"))
        val meme3Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme3.png"))
    ...
    @Test
    fun `getAllEmojisWithCounts returns empty when no tags exist`() = runTest {
        emojiTagDao.getAllEmojisWithCounts().test {
            val result = awaitItem()
            assertThat(result).isEmpty()
            cancelAndIgnoreRemainingEvents()
    ...
    @Test
    fun `deleteEmojiTagsForMeme removes all tags for a meme`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        emojiTagDao.insertEmojiTags(
            listOf(
                createEmojiTag(memeId, "😂", "face_with_tears_of_joy"),
    ...
    @Test
    fun `deleteEmojiTagsForMeme does not affect other memes`() = runTest {
        val meme1Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        val meme2Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme2.png"))
    ...
    @Test
    fun `deleteEmojiTagsForMeme with non-existent meme does nothing`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        emojiTagDao.insertEmojiTags(
            listOf(createEmojiTag(memeId, "😂", "face_with_tears_of_joy"))
        )
    ...
    @Test
    fun `emoji tags are deleted when parent meme is deleted`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        emojiTagDao.insertEmojiTags(
            listOf(
                createEmojiTag(memeId, "😂", "face_with_tears_of_joy"),
    ...
    @Test
    fun `cascade delete does not affect other memes tags`() = runTest {
        val meme1Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        val meme2Id = memeDao.insertMeme(createMeme(filePath = "/storage/meme2.png"))
    ...
    @Test
    fun `observeEmojiTagsForMeme emits when tags are inserted`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
    ...
    @Test
    fun `observeEmojiTagsForMeme emits when tags are deleted`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
        emojiTagDao.insertEmojiTags(
            listOf(
                createEmojiTag(memeId, "😂", "face_with_tears_of_joy"),
    ...
    @Test
    fun `getAllEmojisWithCounts emits when tags change`() = runTest {
        val memeId = memeDao.insertMeme(createMeme(filePath = "/storage/meme1.png"))
