...
class MemeEmbeddingDaoTest {
    ...
    @Test
    fun `insertEmbedding and getEmbeddingByMemeId work correctly`() = runTest {
        // Given
    ...
    @Test
    fun `insertEmbedding replaces existing embedding for same meme`() = runTest {
        // Given
        val memeId = insertTestMeme()
    ...
    @Test
    fun `getAllValidEmbeddings excludes those needing regeneration`() = runTest {
        // Given
    ...
    @Test
    fun `getMemeIdsWithoutEmbeddings returns correct IDs`() = runTest {
        // Given
        val meme1Id = insertTestMeme("meme1")
        val meme2Id = insertTestMeme("meme2")
    ...
    @Test
    fun `markForRegeneration updates the flag`() = runTest {
        // Given
        val memeId = insertTestMeme()
    ...
    @Test
    fun `markOutdatedForRegeneration marks embeddings with different version`() = runTest {
        // Given
        val meme1Id = insertTestMeme("meme1")
        val meme2Id = insertTestMeme("meme2")
    ...
    @Test
    fun `deleteEmbeddingByMemeId removes the embedding`() = runTest {
        // Given
        val memeId = insertTestMeme()
    ...
    @Test
    fun `embedding is cascade deleted when meme is deleted`() = runTest {
        // Given
        val memeId = insertTestMeme()
        embeddingDao.insertEmbedding(createTestEmbedding(memeId))
    ...
    @Test
    fun `countValidEmbeddings returns correct count`() = runTest {
        // Given
        val meme1Id = insertTestMeme("meme1")
        val meme2Id = insertTestMeme("meme2")
        val meme3Id = insertTestMeme("meme3")
    ...
    @Test
    fun `getEmbeddingCountByModelVersion groups correctly`() = runTest {
        // Given
        val meme1Id = insertTestMeme("meme1")
        val meme2Id = insertTestMeme("meme2")
        val meme3Id = insertTestMeme("meme3")
