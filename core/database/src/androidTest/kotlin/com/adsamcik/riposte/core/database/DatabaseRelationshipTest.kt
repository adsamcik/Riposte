...
class DatabaseRelationshipTest {
    ...
    @Test
    fun memeWithEmojis_returnsCorrectEmojis() =
        runTest {
            // Create meme
    ...
    @Test
    fun emojiWithMemes_returnsCorrectMemes() =
        runTest {
            // Create memes
    ...
    @Test
    fun memeWithMultipleEmojis_allRelationshipsWork() =
        runTest {
    ...
    @Test
    fun deleteMeme_removesEmojiRelationships() =
        runTest {
    ...
    @Test
    fun deleteMeme_doesNotDeleteEmoji() =
        runTest {
            val memeId = memeDao.insert(createMemeEntity(title = "To Delete"))
            memeDao.insertMemeEmojiCrossRef(MemeEmojiCrossRef(memeId, "😂"))
    ...
    @Test
    fun transaction_rollbackOnError() =
        runTest {
    ...
    @Test
    fun transaction_commitOnSuccess() =
        runTest {
            val initialCount = memeDao.getAllMemes().first().size
    ...
    @Test
    fun duplicateCrossRef_isIgnored() =
        runTest {
    ...
    @Test
    fun bulkInsert_allItemsInserted() =
        runTest {
    ...
    @Test
    fun bulkDelete_allItemsDeleted() =
        runTest {
    ...
    @Test
    fun getMemesByEmoji_returnsCorrectMemes() =
        runTest {
    ...
    @Test
    fun getMemesWithAnyEmoji_returnsUnion() =
        runTest {
