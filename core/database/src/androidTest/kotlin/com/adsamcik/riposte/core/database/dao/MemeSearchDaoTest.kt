...
class MemeSearchDaoTest {
    ...
    @Test
    fun searchByTitle_returnsMatchingMemes() =
        runTest {
    ...
    @Test
    fun searchByTitle_isCaseInsensitive() =
        runTest {
    ...
    @Test
    fun searchByTitle_returnsEmpty_whenNoMatch() =
        runTest {
    ...
    @Test
    fun searchByExtractedText_returnsMatchingMemes() =
        runTest {
    ...
    @Test
    fun searchByExtractedText_matchesPartialWords() =
        runTest {
    ...
    @Test
    fun fullTextSearch_matchesBothTitleAndText() =
        runTest {
    ...
    @Test
    fun fullTextSearch_ranksResultsByRelevance() =
        runTest {
    ...
    @Test
    fun searchByEmoji_returnsMemesWithEmoji() =
        runTest {
    ...
    @Test
    fun searchByEmoji_returnsEmpty_whenNoMemesWithEmoji() =
        runTest {
            val results = searchDao.searchByEmoji("🤔").first()
    ...
    @Test
    fun searchByMultipleEmojis_returnsUnion() =
        runTest {
    ...
    @Test
    fun searchByAllEmojis_returnsIntersection() =
        runTest {
    ...
    @Test
    fun searchWithTextAndEmoji_returnsMatchingBoth() =
        runTest {
    ...
    @Test
    fun searchWithTextAndEmoji_returnsEmpty_whenNoMatch() =
        runTest {
    ...
    @Test
    fun searchWithLimit_respectsLimit() =
        runTest {
    ...
    @Test
    fun searchWithOffset_skipsResults() =
        runTest {
    ...
    @Test
    fun searchSortedByDate_returnsNewestFirst() =
        runTest {
    ...
    @Test
    fun searchSortedByDate_returnsOldestFirst() =
        runTest {
    ...
    @Test
    fun searchSortedByTitle_alphabeticalOrder() =
        runTest {
    ...
    @Test
    fun searchWithEmptyQuery_returnsAllMemes() =
        runTest {
    ...
    @Test
    fun searchWithSpecialCharacters_handlesGracefully() =
        runTest {
    ...
    @Test
    fun searchWithWhitespace_trimsAndSearches() =
        runTest {
            val results = searchDao.fullTextSearch("  cat  ").first()
    ...
    @Test
    fun searchWithMultipleWords_matchesAnyWord() =
        runTest {
