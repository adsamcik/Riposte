package com.mememymood.sharing
...
class SharingShortcutManager @Inject constructor(
    ...
    private fun buildShortcut(meme: Meme): ShortcutInfoCompat? {
        ...
        val label = meme.title
            ?: meme.emojiTags.firstOrNull()?.emoji
            ?: meme.fileName

        val intent = Intent(Intent.ACTION_SEND).apply {
            setClassName(context.packageName, "com.mememymood.MainActivity")
            type = meme.mimeType
    ...
    companion object {
        ...
        private const val CATEGORY_STICKER_SHARE = "com.mememymood.category.STICKER_SHARE"

        /** Extra key for passing meme ID through shortcut intent. */
        const val EXTRA_SHORTCUT_MEME_ID = "com.mememymood.extra.MEME_ID"
